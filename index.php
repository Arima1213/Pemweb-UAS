...
<body>
  <div class="outer">
    ...
    <section class="section1" style="margin-top: 80px; overflow: hidden;">
      <div class="hero container-fluid vh-100">
        <div class="row align-items-center  px-3">
          <div class="col-6">
            <h1 data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false" data-aos-anchor-placement="center-center" data-aos="fade-right" data-aos-duration="1000" class="py-auto h-100">Menggenggam <span class="text-warning">Harapan</span>,
              <br>
          ...
          <div class="col-6">
            ...
            <div data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false" class="hiasan-satu" data-aos="zoom-in-left" data-aos-offset="-300" data-aos-delay="500" data-aos-duration="300">
            ...
            <div class="card text-white text-center bg-dark pb-2">
              <div class="card-body">
                ...
                <p class=""> Hai Orang Baik dan teman-teman Carat Indonesia! Apa kabar?
                  ...
                  Sangat senang berkesempatan mengajak kalian semua ikut project kebaikan ini.</p><button class="btn bg-warning text-dark">Read More</button>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-12 col-lg-4">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
            <div class="about-text">
              ...
              <p> Berbagi International is a global initiative dedicated to fostering compassion, empathy, and collective action for a better world.</p><a class="btn btn-warning" href="#">Learn More</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container mt-5 mb-5">
        <div class="row">
          <div class="col-md-12">
            <div class="section-header text-center pb-5">
              <h2>Contact Us</h2>
              <p>Terima kasih atas perhatian dan partisipasi Anda. Bersama, mari kita berbuat kebaikan dan memberikan perubahan positif bagi masyarakat yang membutuhkan.</p>
            </div>
          </div>
        </div>
        <div class="row m-0">
    ...
    <footer class="bg-dark p-2 text-center">
      <div class="container">
        <p class="text-white">All Right Reserved By @TakafulIndonesia</p>
      </div>
    </footer>
